...
const weekColors = {
  ...
  cyan: { bg: 'bg-cyan-500', light: 'bg-cyan-50', text: 'text-cyan-700', border: 'border-cyan-200', gradient: 'from-cyan-500 to-cyan-600', ring: 'ring-cyan-500' },
  rose: { bg: 'bg-rose-500', light: 'bg-rose-50', text: 'text-rose-700', border: 'border-rose-200', gradient: 'from-rose-500 to-rose-600', ring: 'ring-rose-500' },
  teal: { bg: 'bg-teal-500', light: 'bg-teal-50', text: 'text-teal-700', border: 'border-teal-200', gradient: 'from-teal-500 to-teal-600', ring: 'ring-teal-500' },
  pink: { bg: 'bg-pink-500', light: 'bg-pink-50', text: 'text-pink-700', border: 'border-pink-200', gradient: 'from-pink-500 to-pink-600', ring: 'ring-pink-500' },
  purple: { bg: 'bg-purple-500', light: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-200', gradient: 'from-purple-500 to-purple-600', ring: 'ring-purple-500' },
};
    ...
    <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-indigo-700 to-violet-700 rounded-2xl p-8 text-white shadow-xl">
          <div className="max-w-2xl">
            ...
            <p className="text-indigo-100 text-sm sm:text-base leading-relaxed">
              ...
              Build 3 production-grade portfolio projects + 1 mega project. Job-ready in 90 days.
              <strong className="text-white block mt-1">MLOps is the #1 most wanted AI role in 2026 — $130K-$300K.</strong>
            </p>
            <div className="flex flex-wrap gap-3 mt-6">
              <Link to="/week/1" className="px-5 py-2.5 bg-white text-indigo-700 rounded-lg font-medium text-sm hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition shadow">
                Start Phase 1 →
              </Link>
      ...
      <FadeIn delay={100}>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            { value: '90', label: 'Days', desc: 'Intensive program', color: 'indigo' },
            { value: '9', label: 'Phases', desc: 'Structured roadmap', color: 'emerald' },
            { value: '4', label: 'Projects', desc: 'Portfolio ready', color: 'violet' },
            { value: '90+', label: 'Subtopics', desc: 'Detailed coverage', color: 'amber' },
          ].map((s) => (
        ...
        <div className="bg-white dark:bg-dark-800 rounded-xl shadow-sm border border-gray-100 dark:border-dark-700 p-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { role: 'LLM Infrastructure Engineer', desc: 'Design and deploy LLM serving infrastructure at scale', salary: '$160K–$300K', demand: '🔥🔥 Fastest Growing', color: 'cyan' },
            ].map((r) => (
              <div key={r.role} className={`p-4 rounded-lg bg-gradient-to-br from-${r.color}-50 dark:from-${r.color}-900/20 to-white dark:to-dark-800 border border-${r.color}-100 dark:border-${r.color}-800/30`}>
          ...
          <div className="grid sm:grid-cols-3 gap-4 text-sm">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 dark:text-gray-500 text-xs mt-0.5">Each day has topics, commands, and a mini project. Check them off as you go.</p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 dark:text-gray-500 text-xs mt-0.5">4 flagship projects (3 + 1 mega project) that go on your resume. These get you hired.</p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-gray-400 dark:text-gray-500 text-xs mt-0.5">Study the Industry Insights page. Know salaries, demand, skills needed. Interview confidently.</p>
              </div>
            </div>
          </div>
        </div>
